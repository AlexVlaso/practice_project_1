...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".decoration_slider", ".decoration_content > div > div", ".no_click", "after_click");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".glazing_slider", ".glazing_content", ".glazing_block", "slick-current");
});
...
var tabs = function tabs(headerSelector, contentSelector, tabSelector, activeClass) {
  var header = document.querySelector(headerSelector);
  var contents = document.querySelectorAll(contentSelector);
  var tabs = header.querySelectorAll(tabSelector);
  ...
  header.addEventListener("click", function (e) {
    var target = e.target;
    var tabClass = tabSelector.replace(/\./, "");

    if (target.classList.contains(tabClass) || target.parentNode.classList.contains(tabClass)) {
      e.preventDefault();
